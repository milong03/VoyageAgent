# VoyageAgent ✈️ - Intelligent Travel Planning AI Agent

VoyageAgent is a production-grade, highly interactive **Intelligent Travel Planning AI Agent** designed to help users curate personalized 2-day itineraries to major global destinations (Tokyo, Paris, Singapore). The system combines dynamic tool calling, dual-layer memory management, a multi-hop RAG pipeline, and a stunning dark-themed glassmorphism single-page web application.
...
## 🛠️ Key Architectural Decisions & Component Design
